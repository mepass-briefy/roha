...
# v12: discovery를 downstream(strategy·ux·security·features) depends_on에 연결(입력 전달). v11 보존.
WF = json.loads((BASE / "workflow" / "site-build.v12.json").read_text(encoding="utf-8"))
